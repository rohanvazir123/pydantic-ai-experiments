...
| [16_token_cost.md](16_token_cost.md) | Token Cost Analysis | Stage-by-stage cost breakdown, cost at scale (500 / 10K / 100K queries/day), model routing savings, schema compression, caching ROI, fine-tuning break-even, fast mode trade-offs, cost monitoring |
| [17_query_normalization_schema_enrichment.md](17_query_normalization_schema_enrichment.md) | Query Normalization and Schema Enrichment | Normalization pipeline (case, abbreviations, synonyms, typos, pronouns), impact on cache hit rate, schema enrichment layers (table/column descriptions, glossary, join paths), automated enrichment, keeping enrichment fresh |
| [18_spider2_lite_eval.md](18_spider2_lite_eval.md) | Spider2-lite Benchmarking | Setup (SQLite/BigQuery/Snowflake), prediction format, wiring your pipeline, external knowledge injection, dialect-specific generation (BigQuery/Snowflake/SQLite syntax table), segmented failure analysis, execution-based evaluation trade-offs, CI regression gate |
