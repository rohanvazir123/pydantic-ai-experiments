...
```bash
mkdir -p basics/basics/src/components
```
...
Now replace everything in `basics/basics/src/App.tsx` with this:
...
Create `basics/basics/src/components/Counter.tsx`:
...
Create `basics/basics/src/components/UserCard.tsx`:
...
Create `basics/basics/src/components/UserList.tsx`:
...
Your `basics/basics/src/` should now have:
