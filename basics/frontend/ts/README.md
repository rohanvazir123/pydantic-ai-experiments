...
Create scratch files at `basics/frontend/day1_exercises/src/scratch-ts.ts`. The dev server ignores unimported files, so you can write freely without breaking the app.
...
Morning (2 h)
  ...
  Do:   In basics/frontend/day1_exercises/src/scratch-ts.ts, annotate 10 small functions from scratch
...
Create `basics/frontend/day1_exercises/src/scratch-ts.ts`:
