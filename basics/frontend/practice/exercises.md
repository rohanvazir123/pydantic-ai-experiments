...
All exercises use the Vite project at `basics/frontend/day1_exercises/`. Run `npm run dev` from that directory before you start.
...
- [ ] No TypeScript errors (`tsc --noEmit` in `basics/frontend/day1_exercises/`)
