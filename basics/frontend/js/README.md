...
Afternoon (1.5 h)
  ...
  Do:   In basics/frontend/day1_exercises/src/, create scratch.ts and implement the exercises below
...
Create `basics/frontend/day1_exercises/src/scratch-js.ts` and implement each of these without looking at the doc:
