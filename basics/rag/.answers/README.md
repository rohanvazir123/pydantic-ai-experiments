...
| [13_data_ingestion_cleaning_metadata.md](13_data_ingestion_cleaning_metadata.md) | Data Ingestion — Cleaning, Metadata, Images | Boilerplate removal, encoding fixes, deduplication, OCR noise, fine-grained citation schema (author/title/chapter/page/paragraph/table/column), automated metadata extraction, image-to-text conversion by type (OCR, charts, tables, formulas, diagrams), full 4-stage ingestion pipeline |
| [14_domain_rag_eval.md](14_domain_rag_eval.md) | Domain-Specific RAG Benchmarking | BEIR (retrieval-only, 19 datasets, NDCG/Recall/MRR), FinanceBench (financial E2E RAG), SQuAD 2.0 and SQuAD-lite (reading comprehension + abstention), BioASQ, QASPER, HotpotQA (multi-hop), LegalBench/CUAD, RAGAS synthetic generation, benchmark selection guide, failure segmentation, NDCG-to-E2E gap, CI regression gates |
